import { IngredientsFetchStatus, TIngredient } from 'redux/actionTypes'
import {
  setRequestStatus,
  setErrorStatus,
  setSuccessStatus,
...
describe('Data action creators', () => {
  it('Data action - request', () => {
    const expectedAction = {
      type: IngredientsFetchStatus.INGREDIENTS_REQUEST,
    }

    expect(setRequestStatus()).toEqual(expectedAction)
  })

  it('Data action - error', () => {
    const expectedAction = {
      type: IngredientsFetchStatus.INGREDIENTS_ERROR,
    }

    expect(setErrorStatus()).toEqual(expectedAction)
  })

  it('Data action - succes', () => {
